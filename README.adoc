...
`src/main/java/com/exampe/batchprocessing/InactiveUserJobConfiguration.java`:

====
[source,java,tabsize=2]
----
include::complete/src/main/java/com/example/batchprocessing/InactiveUserJobConfiguration.java[tag=setup]
...
Now add the following beans to your `InactiveUserJobConfiguration` class to define a reader, a processor, and a writer:

====
[source,java,tabsize=2,indent=0]
----
include::complete/src/main/java/com/example/batchprocessing/InactiveUserJobConfiguration.java[tag=readerwriterprocessor]
----
====
...
The last chunk (from `src/main/java/com/example/batchprocessing/InactiveUserJobConfiguration.java`)
shows the actual job configuration:

====
[source,java,tabsize=2,indent=0]
----
include::complete/src/main/java/com/example/batchprocessing/InactiveUserJobConfiguration.java[tag=jobstep]
----
====
